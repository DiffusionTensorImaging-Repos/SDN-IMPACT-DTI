...
<div class="callout">These two sessions produce garbage d′ that was dragging the group social mean to zero. With them removed, social d′ is a genuine above-chance signal (Section 3). No other subject was excluded for d′; a couple more drop from the <i>bias</i> metrics only because they have no negative-valence recall trials, so a positivity score is undefined for them.</div>
</div>
